...
CREATE TABLE veiculo(
    id_ve INTEGER(3) PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE vaga_estaci(
    ...
    id_ve INTEGER(3) NOT NULL UNIQUE,
    data DATE NOT NULL,
...
(2,2,CURDATE(),"06:07:12","08:07:12",10),
(3,3,CURDATE(),"06:07:12","09:07:12",10),
(4,4,CURDATE(),"06:07:12","10:07:12",10),
(5,5,CURDATE(),"06:07:12","10:27:12",10);

CREATE VIEW vw_funcionario as
SELECT e.id_es, v.id_ve, v.placa, v.veiculo, e.data, e.hora_e, e.hora_s, 
round(TIME_TO_SEC(TIMEDIFF(hora_s, hora_e))/3600.0,2)  AS hora_dif,
